...
.then(result => {
  ...
  moduleViewRenderer.getViewBadges(['Figma', 'UI', 'WCAG standards'], document.getElementById('skills'));
  moduleViewRenderer.getViewBadges(['Design systems', 'Accessibility'], document.getElementById('badges'));
