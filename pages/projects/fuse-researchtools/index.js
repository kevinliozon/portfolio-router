...
.then(result => {
  ...
  moduleViewRenderer.getViewBadges(['Empathy maps', 'Analytics', 'Figma'], document.getElementById('skills'));
  moduleViewRenderer.getViewBadges(['Research', 'Tools'], document.getElementById('badges'));
