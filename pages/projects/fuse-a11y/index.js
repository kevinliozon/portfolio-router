...
.then(result => {
  ...
  moduleViewRenderer.getViewBadges(['Communication', 'WCAG standards', 'Dev tools'], document.getElementById('skills'));
  moduleViewRenderer.getViewBadges(['Accessibility', 'Client-facing'], document.getElementById('badges'));
